...
public class DeviceChooserActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (getService().mRequest.isSingleDevice()) {
            ...
            setTitle(Html.fromHtml(getString(R.string.confirmation_title, new Object[]{getCallingAppName(), deviceFilterPair.getDisplayName()}), 0));
            ...
            setTitle(Html.fromHtml(getString(R.string.chooser_title, new Object[]{getCallingAppName()}), 0));
