...
public final class PrintOptionsLayout extends ViewGroup {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (size != 0) {
            i3 = ((size - this.mPaddingLeft) - this.mPaddingRight) / this.mColumnCount;
        } else {
            i3 = 0;
        }
            ...
            while (i11 < this.mColumnCount && (i4 = (this.mColumnCount * i8) + i11) < childCount) {
                ...
                if (childAt.getVisibility() == 8) {
                    ...
                    if (i3 > 0) {
                        ...
                        i5 = i3;
                        childMeasureSpec = getChildMeasureSpec(i, getPaddingStart() + getPaddingEnd() + iMax, marginLayoutParams.width);
                    }
                    i6 = childCount;
                    childAt.measure(childMeasureSpec, getChildMeasureSpec(i2, getPaddingTop() + getPaddingBottom() + i9, marginLayoutParams.height));
