...
public class LockSettingsService extends ILockSettings.Stub {
    ...
    private void showEncryptionNotificationForProfile(UserHandle userHandle) {
        ...
        CharSequence text = resources.getText(R.string.mmcc_authentication_reject);
        CharSequence text2 = resources.getText(R.string.keyguard_accessibility_widget_reorder_end);
        CharSequence text3 = resources.getText(R.string.keyguard_accessibility_widget_empty_slot);
