...
class MtpNotificationManager {
    ...
    void showNotification(UsbDevice usbDevice) {
        ...
        Notification.Builder category = new Notification.Builder(this.mContext, SystemNotificationChannels.USB).setContentTitle(resources.getString(R.string.miniresolver_open_in_personal, usbDevice.getProductName())).setContentText(resources.getString(R.string.miniresolver_call_information)).setSmallIcon(R.drawable.pointer_spot_hover_vector).setCategory("sys");
