...
public class UsbDeviceManager implements ActivityManagerInternal.ScreenObserver {
    ...
    static abstract class UsbHandler extends Handler {
        ...
        protected void updateUsbNotification(boolean z) {
            ...
            CharSequence text2 = resources.getText(R.string.miniresolver_open_work);
            int i3 = 32;
            if (this.mAudioAccessoryConnected && !this.mAudioAccessorySupported) {
                ...
                if (this.mCurrentFunctions == 4) {
                    i = R.string.miniresolver_open_in_work;
                    i2 = 27;
                } else if (this.mCurrentFunctions == 16) {
                    i = R.string.miniresolver_private_space_phone_information;
                    i2 = 28;
                } else if (this.mCurrentFunctions == 8) {
                    i = R.string.mime_type_video;
                    i2 = 29;
                } else if (this.mCurrentFunctions == 32) {
                    i = R.string.miniresolver_switch;
                    i2 = 47;
                } else if (this.mCurrentFunctions == 2) {
                    i = R.string.mime_type_spreadsheet;
                    i2 = 30;
                } else {
                    i = 0;
                    i2 = 0;
                ...
                if (this.mSourcePower) {
                    if (i != 0) {
                        text2 = resources.getText(R.string.miniresolver_private_space_messages_information);
                    }
                    i3 = 31;
                    i = 17041010;
                } else if (i == 0) {
            ...
            if (i3 != this.mUsbNotificationId || z) {
                ...
                if (i3 != 0) {
                    ...
                    if (i != 17041013) {
                        ...
                        text = resources.getText(R.string.miniresolver_switch_to_work);
                    }
