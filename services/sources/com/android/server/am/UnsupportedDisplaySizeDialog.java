...
public class UnsupportedDisplaySizeDialog {
    ...
    public UnsupportedDisplaySizeDialog(final AppWarnings appWarnings, Context context, ApplicationInfo applicationInfo) {
        ...
        this.mDialog = new AlertDialog.Builder(context).setPositiveButton(R.string.ok, (DialogInterface.OnClickListener) null).setMessage(context.getString(R.string.mime_type_image_ext, applicationInfo.loadSafeLabel(context.getPackageManager()))).setView(R.layout.preference_list_content_single).create();
        this.mDialog.create();
