    ...
    private Notification buildNotification(UserHandle userHandle, int i) {
        ...
        try {
            ...
            if (profileOwner != null) {
                string2 = resources.getString(R.string.mediasize_iso_b1, this.mService.getProfileOwnerName(userHandle.getIdentifier()));
                ...
                if (this.mService.getDeviceOwnerUserId() == userHandle.getIdentifier()) {
                    ...
                    string = resources.getString(R.string.mediasize_iso_b1, this.mService.getDeviceOwnerName());
                } else {
                    string = resources.getString(R.string.mediasize_iso_b0);
