...
public class InputMethodManagerService extends IInputMethodManager.Stub implements ServiceConnection, Handler.Callback {
    ...
    public InputMethodManagerService(Context context) {
        ...
        this.mSlotIme = this.mContext.getString(R.string.mediasize_iso_c4);
    ...
    private void updateSystemUiLocked(IBinder iBinder, int i, int i2) {
        ...
        if (inputMethodInfo != null && zShouldShowImeSwitcherLocked) {
            this.mImeSwitcherNotification.setContentTitle(this.mRes.getText(R.string.lockscreen_password_wrong)).setContentText(InputMethodUtils.getImeAndSubtypeDisplayName(this.mContext, inputMethodInfo, this.mCurrentSubtype)).setContentIntent(this.mImeSwitchPendingIntent);
            try {
