...
public class PermissionManagerService {
    ...
    private void grantPermissions(PackageParser.Package r28, boolean z, String str, PermissionManagerInternal.PermissionCallback permissionCallback) {
        ...
        boolean z4;
        int[] iArr2;
        boolean zGrantSignaturePermission;
            ...
            if (packageSetting4.isSharedUser()) {
                ...
                synchronized (this.mLock) {
                    ...
                    while (i3 < size) {
                        ...
                        boolean z7 = z2;
                        boolean z8 = r28.applicationInfo.targetSdkVersion >= 23;
                        ...
                        if (permissionLocked == null || permissionLocked.getSourcePackageSetting() == null) {
                            ...
                            if (!r28.applicationInfo.isInstantApp() || permissionLocked.isInstant()) {
                                if (!permissionLocked.isRuntimeOnly() || z8) {
                                    ...
                                    if (permissionLocked.isNormal()) {
                                        c = 2;
                                        zGrantSignaturePermission = false;
                                        ...
                                        if (permissionLocked.isSignature()) {
                                            zGrantSignaturePermission = grantSignaturePermission(name, r28, permissionLocked, permissionsState);
                                            if (zGrantSignaturePermission) {
                                                c = 2;
                                            }
                                            if (PackageManagerService.DEBUG_PERMISSIONS) {
                                            }
                                        ...
                                        z6 = true;
                                    } else if (z8 || this.mSettings.mPermissionReviewRequired) {
                                        ...
                                        if (c != 1) {
                                            if (!packageSetting4.isSystem() && packageSetting4.areInstallPermissionsFixed() && !zGrantSignaturePermission && !permissionsState.hasInstallPermission(name) && !isNewPlatformPermissionForPackage(name, r28)) {
                                                c = 1;
                                            }
                                            switch (c) {
                                                case 2:
                                                ...
                                                case 3:
                                                    ...
                                                    while (i6 < length) {
                                                        ...
                                                        if (permissionsState.hasRuntimePermission(name, i7)) {
                                                            ...
                                                            if (this.mSettings.mPermissionReviewRequired && z8 && (flags & 64) != 0) {
                                                            ...
                                                            i2 = length;
                                                            iArr3 = userIds;
                                                            if (this.mSettings.mPermissionReviewRequired && !z8) {
                                                            ...
                                                            } else if (z8 && zIsPackageNeedsReview && sCtaManager.isPlatformPermission(permissionLocked.getSourcePackageName(), permissionLocked.getName()) && (flags & 64) == 0 && (flags & 16) == 0) {
                                                                flags |= 64;
                                                                iArrAppendInt = ArrayUtils.appendInt(iArrAppendInt4, i7);
                                                                iArrAppendInt4 = iArrAppendInt;
                                                            }
