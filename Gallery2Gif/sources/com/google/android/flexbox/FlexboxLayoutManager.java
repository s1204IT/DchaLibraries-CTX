    ...
    private class AnchorInfo {
        ...
        private void reset() {
            ...
            if (this.this$0.isMainAxisDirectionHorizontal()) {
                if (this.this$0.mFlexWrap == 0) {
                    this.mLayoutFromEnd = this.this$0.mFlexDirection == 1;
                    return;
                } else {
                    this.mLayoutFromEnd = this.this$0.mFlexWrap == 2;
                    return;
                }
            }
            if (this.this$0.mFlexWrap == 0) {
                this.mLayoutFromEnd = this.this$0.mFlexDirection == 3;
            } else {
                this.mLayoutFromEnd = this.this$0.mFlexWrap == 2;
            }
        }
        ...
        private void assignCoordinateFromPadding() {
            if (!this.this$0.isMainAxisDirectionHorizontal() && this.this$0.mIsRtl) {
                this.mCoordinate = this.mLayoutFromEnd ? this.this$0.mOrientationHelper.getEndAfterPadding() : this.this$0.getWidth() - this.this$0.mOrientationHelper.getStartAfterPadding();
            } else {
        ...
        private void assignFromView(View anchor) {
            if (!this.this$0.isMainAxisDirectionHorizontal() && this.this$0.mIsRtl) {
                if (this.mLayoutFromEnd) {
                    this.mCoordinate = this.this$0.mOrientationHelper.getDecoratedStart(anchor) + this.this$0.mOrientationHelper.getTotalSpaceChange();
                } else {
                    this.mCoordinate = this.this$0.mOrientationHelper.getDecoratedEnd(anchor);
                }
            } else if (this.mLayoutFromEnd) {
                this.mCoordinate = this.this$0.mOrientationHelper.getDecoratedEnd(anchor) + this.this$0.mOrientationHelper.getTotalSpaceChange();
            } else {
                this.mCoordinate = this.this$0.mOrientationHelper.getDecoratedStart(anchor);
            }
            this.mPosition = this.this$0.getPosition(anchor);
            this.mAssignedFromSavedState = false;
            int flexLinePosition = this.this$0.mFlexboxHelper.mIndexToFlexLine[this.mPosition];
