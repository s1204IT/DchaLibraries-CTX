    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                int[] scrollConsumed = this.this$0.mScrollConsumed;
                ...
                int overscrollX = 0;
                int overscrollY = 0;
                if (this.this$0.dispatchNestedPreScroll(dx, dy, scrollConsumed, null, 1)) {
                    dx -= scrollConsumed[0];
                    dy -= scrollConsumed[1];
                }
                if (this.this$0.mAdapter != null) {
                    this.this$0.scrollStep(dx, dy, this.this$0.mScrollStepConsumed);
                    hresult = this.this$0.mScrollStepConsumed[0];
                    vresult = this.this$0.mScrollStepConsumed[1];
                ...
                if (!this.this$0.dispatchNestedScroll(hresult, adapterSize2, overscrollX2, overscrollY2, null, 1) && (overscrollX2 != 0 || overscrollY2 != 0)) {
                ...
                if (hresult != 0 || adapterSize2 != 0) {
                    this.this$0.dispatchOnScrolled(hresult, adapterSize2);
                }
                if (!this.this$0.awakenScrollBars()) {
                    this.this$0.invalidate();
                }
                boolean fullyConsumedVertical = dy != 0 && this.this$0.mLayout.canScrollVertically() && adapterSize2 == dy;
                ...
                if (scroller.isFinished() || (!fullyConsumedAny && !this.this$0.hasNestedScrollingParent(1))) {
    ...
    public final class Recycler {
        ...
        boolean validateViewHolderForOffsetPosition(ViewHolder holder) {
            ...
            if (holder.mPosition < 0 || holder.mPosition >= this.this$0.mAdapter.getItemCount()) {
                throw new IndexOutOfBoundsException("Inconsistency detected. Invalid view holder adapter position" + holder + this.this$0.exceptionLabel());
            }
            if (!this.this$0.mState.isPreLayout()) {
                int type = this.this$0.mAdapter.getItemViewType(holder.mPosition);
                if (type != holder.getItemViewType()) {
                    return false;
                }
            }
            return !this.this$0.mAdapter.hasStableIds() || holder.getItemId() == this.this$0.mAdapter.getItemId(holder.mPosition);
        }
        ...
        ViewHolder tryGetViewHolderForPositionByDeadline(int position, boolean dryRun, long deadlineNs) {
            ...
            if (position < 0 || position >= this.this$0.mState.getItemCount()) {
                throw new IndexOutOfBoundsException("Invalid item position " + position + "(" + position + "). Item count:" + this.this$0.mState.getItemCount() + this.this$0.exceptionLabel());
            }
            ...
            if (holder == null) {
                ...
                if (offsetPosition < 0 || offsetPosition >= this.this$0.mAdapter.getItemCount()) {
                    throw new IndexOutOfBoundsException("Inconsistency detected. Invalid item position " + position + "(offset:" + offsetPosition + ").state:" + this.this$0.mState.getItemCount() + this.this$0.exceptionLabel());
                }
                int type = this.this$0.mAdapter.getItemViewType(offsetPosition);
                if (this.this$0.mAdapter.hasStableIds() && (holder = getScrapOrCachedViewForId(this.this$0.mAdapter.getItemId(offsetPosition), type, dryRun)) != null) {
            ...
            if (fromScrapOrHiddenOrCache2 && !this.this$0.mState.isPreLayout() && holder2.hasAnyOfTheFlags(8192)) {
                ...
                if (this.this$0.mState.mRunSimpleAnimations) {
                    ...
                    ItemAnimator.ItemHolderInfo info = this.this$0.mItemAnimator.recordPreLayoutInformation(this.this$0.mState, holder2, changeFlags | 4096, holder2.getUnmodifiedPayloads());
                    this.this$0.recordAnimationInfoIfBouncedHiddenView(holder2, info);
                }
            }
            boolean bound = false;
            if (this.this$0.mState.isPreLayout() && holder2.isBound()) {
                holder2.mPreLayoutPosition = position;
            } else if (!holder2.isBound() || holder2.needsUpdate() || holder2.isInvalid()) {
                bound = tryBindViewHolderByDeadline(holder2, this.this$0.mAdapterHelper.findPositionOffset(position), position, deadlineNs);
            }
        ...
        void recycleViewHolderInternal(ViewHolder holder) {
            ...
            if (holder.isTmpDetached()) {
                throw new IllegalArgumentException("Tmp detached view should be removed from RecyclerView before it can be recycled: " + holder + this.this$0.exceptionLabel());
            }
            if (holder.shouldIgnore()) {
                ...
                if (this.mViewCacheMax > 0 && !holder.hasAnyOfTheFlags(526)) {
                    ...
                    if (RecyclerView.ALLOW_THREAD_GAP_WORK && cachedViewSize > 0 && !this.this$0.mPrefetchRegistry.lastPrefetchIncludedPosition(holder.mPosition)) {
                        ...
                        while (cacheIndex >= 0) {
                            ...
                            if (!this.this$0.mPrefetchRegistry.lastPrefetchIncludedPosition(cachedPos)) {
                                break;
                            } else {
                                cacheIndex--;
                            }
        ...
        ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int position, boolean dryRun) {
            ...
            if (!dryRun && (view = this.this$0.mChildHelper.findHiddenNonRemovedView(position)) != null) {
                ...
                if (layoutIndex == -1) {
                    throw new IllegalStateException("layout index should not be -1 after unhiding a view:" + vh + this.this$0.exceptionLabel());
                }
