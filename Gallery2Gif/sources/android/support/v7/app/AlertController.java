    ...
    private static final class ButtonHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (i != 1) {
                switch (i) {
                    case -3:
                    case ExtFieldsUtils.NOT_SUPPORT_VIDEO_ROTATION:
                    case -1:
        ...
        private void createListView(final AlertController dialog) {
            ...
            if (this.mIsMultiChoice) {
                if (this.mCursor == null) {
                    adapter2 = new ArrayAdapter<CharSequence>(this.mContext, dialog.mMultiChoiceItemLayout, android.R.id.text1, this.mItems) {
                        @Override
