...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (true) {
            ...
            if (layoutState.mLayoutDirection == r15) {
                int maxEnd2 = layoutParams2.mFullSpan ? getMaxEnd(i7) : span3.getEndLine(i7);
                ...
                int minStart = layoutParams2.mFullSpan ? getMinStart(i7) : span3.getStartLine(i7);
            ...
            if (isLayoutRTL() && this.mOrientation == r15) {
                ...
                int startAfterPadding2 = layoutParams2.mFullSpan ? this.mSecondaryOrientation.getStartAfterPadding() : (span3.mIndex * this.mSizePerSpan) + this.mSecondaryOrientation.getStartAfterPadding();
        ...
        int i8 = maxEnd;
        return i8 > 0 ? Math.min(layoutState.mAvailable, i8) : r7 == true ? 1 : 0;
    }
