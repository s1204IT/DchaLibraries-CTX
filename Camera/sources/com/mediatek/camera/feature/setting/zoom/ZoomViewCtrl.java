...
public class ZoomViewCtrl {
    ...
    private void updateOrientation(int i) {
        ...
        if (i != 0) {
            if (i == 90) {
                layoutParams.setMargins(layoutParams.leftMargin, dpToPixel(2), layoutParams.rightMargin, layoutParams.bottomMargin);
            } else if (i == 180) {
                layoutParams.setMargins(layoutParams.leftMargin, dpToPixel(120), layoutParams.rightMargin, layoutParams.bottomMargin);
            } else if (i == 270) {
            }
        } else if (CameraUtil.isTablet()) {
            layoutParams.setMargins(layoutParams.leftMargin, dpToPixel(100), layoutParams.rightMargin, layoutParams.bottomMargin);
        } else {
            layoutParams.setMargins(layoutParams.leftMargin, dpToPixel(40), layoutParams.rightMargin, layoutParams.bottomMargin);
        }
