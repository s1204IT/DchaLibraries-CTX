...
public class SdofViewCtrl {
    ...
    private void updateOrientation(int i) {
        ...
        if (i == 0) {
            layoutParams.setMargins(layoutParams.leftMargin, layoutParams.topMargin, layoutParams.rightMargin, dpToPixel(130));
        } else if (i == 90) {
            layoutParams.setMargins(layoutParams.leftMargin, layoutParams.topMargin, layoutParams.rightMargin, dpToPixel(40));
        } else if (i != 180) {
            if (i == 270) {
            }
        }
