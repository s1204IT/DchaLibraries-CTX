...
class ModeItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        if (viewHolder instanceof ModeViewHolder) {
            ...
            modeViewHolder.mTextView.setText(this.mModes.get(i).mName);
            modeViewHolder.mModeView.setContentDescription(this.mModes.get(i).mName);
            ...
            if (this.mModes.get(i).mName.equals(this.mCurrentModeName)) {
                if (this.mModes.get(i).mSelectedIcon != null) {
                    modeViewHolder.mImageView.setImageDrawable(this.mModes.get(i).mSelectedIcon);
                } else {
                    modeViewHolder.mImageView.setImageResource(R.drawable.ic_normal_mode_selected);
                }
            } else if (this.mModes.get(i).mUnselectedIcon != null) {
                modeViewHolder.mImageView.setImageDrawable(this.mModes.get(i).mUnselectedIcon);
            } else {
                modeViewHolder.mImageView.setImageResource(R.drawable.ic_normal_mode_unselected);
            }
            modeViewHolder.mTextView.setTag(this.mModes.get(i));
        }
    }
