        ...
        private class RespondCameraHandler extends Handler {
            ...
            RespondCameraHandler(Looper looper) {
                ...
                this.mStateCallback = new CameraDevice.StateCallback() {
                    ...
                    public void onOpened(CameraDevice cameraDevice) {
                        ...
                        Camera2ProxyCreatorImpl.this.mRetryCount = 0;
            ...
            private void createHandlerAndProxy(CameraDevice cameraDevice) {
                if (cameraDevice != this.mCameraDevice) {
                    ...
                    this.mRequestHandler = new Camera2Handler(Camera2ProxyCreatorImpl.this.mCameraId, Camera2ProxyCreatorImpl.this.mRequestThread.getLooper(), Camera2ProxyCreatorImpl.this.mRespondHandler, cameraDevice, this.mDeviceInfoListener);
