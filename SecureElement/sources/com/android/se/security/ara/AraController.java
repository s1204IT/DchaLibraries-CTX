...
public class AraController {
    ...
    private void readAllAccessRules() throws AccessControlException, IOException {
        try {
            ...
            BerTlv berTlvCreateDO = Response_DO_Factory.createDO(allAccessRules);
            if (berTlvCreateDO == null || !(berTlvCreateDO instanceof Response_ALL_AR_DO)) {
                throw new AccessControlException("No valid data object found");
            }
            ArrayList<REF_AR_DO> refArDos = ((Response_ALL_AR_DO) berTlvCreateDO).getRefArDos();
