...
public class ZenDurationDialog {
    ...
    public Dialog createDialog() {
        ...
        AlertDialog.Builder positiveButton = new AlertDialog.Builder(this.mContext).setTitle(R.string.zen_mode_duration_settings_title).setNegativeButton(R.string.cancel, (DialogInterface.OnClickListener) null).setPositiveButton(R.string.okay, new DialogInterface.OnClickListener() {
            @Override
    ...
    protected void updateUi(ConditionTag conditionTag, View view, int i) {
        ...
        switch (i) {
            case 0:
                string = this.mContext.getString(android.R.string.oneMonthDurationPast);
                break;
            case 1:
