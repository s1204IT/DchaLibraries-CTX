...
public class DhcpClient extends StateMachine {
    ...
    protected static HashMap<String, DhcpResults> sDhcpResultMap;
    ...
    public DhcpClient(String str, Handler handler) {
        super(str, handler);
        ...
        this.mRandom = null;
        this.mKickAlarm = null;
        this.mTimeoutAlarm = null;
        this.mRenewAlarm = null;
        this.mRebindAlarm = null;
        this.mExpiryAlarm = null;
    }
            ...
            while (!this.mStopped) {
                try {
                    ...
                    try {
                        ...
                        Log.d(DhcpClient.TAG, "Received packet: " + dhcpPacketDecodeFullPacket);
                        DhcpClient.this.sendMessage(DhcpClient.CMD_RECEIVED_PACKET, dhcpPacketDecodeFullPacket);
                    } catch (DhcpPacket.ParseException e2) {
                        e = e2;
                        Log.e(DhcpClient.TAG, "Can't parse packet: " + e.getMessage());
                        Log.d(DhcpClient.TAG, HexDump.dumpHexString(this.mPacket, 0, i));
                    ...
                    if (!this.mStopped) {
                        Log.e(DhcpClient.TAG, "Read error", e3);
