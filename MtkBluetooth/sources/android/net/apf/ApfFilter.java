...
public class ApfFilter {
    ...
    private static int[] filterEthTypeBlackList(int[] iArr) {
        ...
        while (true) {
            ...
            int i2 = iArr[i];
            if (i2 >= ETH_TYPE_MIN && i2 <= 65535 && !arrayList.contains(Integer.valueOf(i2))) {
    ...
    class Ra {
        ...
        Ra(byte[] bArr, int i) throws InvalidRaException {
            ...
            if (BitUtils.getUint16(this.mPacket, 12) != OsConstants.ETH_P_IPV6 || BitUtils.getUint8(this.mPacket, 20) != OsConstants.IPPROTO_ICMPV6 || BitUtils.getUint8(this.mPacket, ApfFilter.ICMP6_TYPE_OFFSET) != 134) {
                throw new InvalidRaException("Not an ICMP6 router advertisement");
            }
            RaEvent.Builder builder = new RaEvent.Builder();
            int iAddNonLifetime = addNonLifetime(addNonLifetime(addNonLifetime(0, 15, 3), ICMP6_RA_CHECKSUM_OFFSET, 2), 60, 2);
        ...
        long minLifetime(byte[] bArr, int i) {
            ...
            while (true) {
                ...
                if (i3 < this.mNonLifetimes.size()) {
                    ...
                    if (iIntValue != 15 && iIntValue != ICMP6_RA_CHECKSUM_OFFSET) {
    ...
    private void generateIPv4FilterLocked(ApfGenerator apfGenerator) throws ApfGenerator.IllegalInstructionException {
        if (this.mMulticastFilter) {
            ...
            apfGenerator.addLoadImmediate(ApfGenerator.Register.R0, DHCP_CLIENT_MAC_OFFSET);
    ...
    private void generateIPv6FilterLocked(ApfGenerator apfGenerator) throws ApfGenerator.IllegalInstructionException {
        ...
        if (this.mMulticastFilter) {
            if (this.mInDozeMode) {
                ...
                apfGenerator.addLoad8(ApfGenerator.Register.R0, ICMP6_TYPE_OFFSET);
    ...
    private ApfGenerator emitPrologueLocked() throws ApfGenerator.IllegalInstructionException {
        ...
        if (this.mDrop802_3Frames) {
            ...
            apfGenerator.addJumpIfR0LessThan(ETH_TYPE_MIN, this.mCountAndDropLabel);
        }
