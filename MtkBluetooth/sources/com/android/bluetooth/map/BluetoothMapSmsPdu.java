        ...
        if (i4 == 1) {
            ...
            while (i9 < i4) {
                ...
                if (i5 == 1) {
                    ...
                    i2 = i7;
                    i3 = i6;
                    bArr = com.android.internal.telephony.gsm.SmsMessage.getSubmitPdu((String) null, str3, (String) arrayListFragmentText.get(i9), false, SmsHeader.toByteArray(smsHeader), i6, i2, i8).encodedMessage;
                    z = false;
                } else {
                    i = i10;
                    i2 = i7;
                    ...
                    z = false;
                    bArr = SmsMessage.getSubmitPdu(str3, userData, false).encodedMessage;
                }
                int i11 = i2;
