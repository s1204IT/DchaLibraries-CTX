    ...
    private void createReceiver() {
        ...
        this.mReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                for (Intent intent2 : intentArr) {
                    ...
                    if (listQueryIntentContentProviders != null) {
                        ...
                        while (true) {
                            ...
                            if (next != null && encodedSchemeSpecificPart2.equals(next.providerInfo.packageName)) {
                ...
                if (resolveInfo != null) {
                    if (BluetoothMapAppObserver.D) {
                        Log.d(BluetoothMapAppObserver.TAG, "Found " + resolveInfo.providerInfo.packageName + " application of type " + type3);
                    }
