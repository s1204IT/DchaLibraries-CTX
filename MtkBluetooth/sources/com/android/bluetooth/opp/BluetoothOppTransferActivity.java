...
public class BluetoothOppTransferActivity extends AlertActivity implements DialogInterface.OnClickListener {
    ...
    private void customizeViewContent() {
        if (this.mWhichDialog == 0 || this.mWhichDialog == 1) {
            ...
            this.mLine1View.setText(getString(R.string.download_line1, new Object[]{this.mTransInfo.mDeviceName}));
            this.mLine2View = (TextView) this.mView.findViewById(R.id.line2_view);
            this.mLine2View.setText(getString(R.string.download_line2, new Object[]{this.mTransInfo.mFileName}));
            this.mLine3View = (TextView) this.mView.findViewById(R.id.line3_view);
            String string = getString(R.string.download_line3, new Object[]{Formatter.formatFileSize(this, this.mTransInfo.mTotalBytes)});
            ...
            this.mLine1View = (TextView) this.mView.findViewById(R.id.line1_view);
            this.mLine1View.setText(getString(R.string.upload_line1, new Object[]{this.mTransInfo.mDeviceName}));
            this.mLine2View = (TextView) this.mView.findViewById(R.id.line2_view);
            this.mLine2View.setText(getString(R.string.download_line2, new Object[]{this.mTransInfo.mFileName}));
            this.mLine3View = (TextView) this.mView.findViewById(R.id.line3_view);
            String string2 = getString(R.string.upload_line3, new Object[]{this.mTransInfo.mFileType, Formatter.formatFileSize(this, this.mTransInfo.mTotalBytes)});
            ...
            if (this.mTransInfo.mStatus == 494) {
                this.mLine1View = (TextView) this.mView.findViewById(R.id.line1_view);
                this.mLine1View.setText(getString(R.string.bt_sm_2_1, new Object[]{this.mTransInfo.mDeviceName}));
                this.mLine2View = (TextView) this.mView.findViewById(R.id.line2_view);
                this.mLine2View.setText(getString(R.string.download_fail_line2, new Object[]{this.mTransInfo.mFileName}));
                this.mLine3View = (TextView) this.mView.findViewById(R.id.line3_view);
                this.mLine3View.setText(getString(R.string.bt_sm_2_2, new Object[]{Formatter.formatFileSize(this, this.mTransInfo.mTotalBytes)}));
            } else {
                this.mLine1View = (TextView) this.mView.findViewById(R.id.line1_view);
                ...
                this.mLine2View.setText(getString(R.string.download_fail_line2, new Object[]{this.mTransInfo.mFileName}));
                this.mLine3View = (TextView) this.mView.findViewById(R.id.line3_view);
                this.mLine3View.setText(getString(R.string.download_fail_line3, new Object[]{BluetoothOppUtility.getStatusDescription(this, this.mTransInfo.mStatus, this.mTransInfo.mDeviceName)}));
            }
            this.mLine5View = (TextView) this.mView.findViewById(R.id.line5_view);
            this.mLine5View.setVisibility(8);
        } else if (this.mWhichDialog == 5) {
            this.mLine1View = (TextView) this.mView.findViewById(R.id.line1_view);
            this.mLine1View.setText(getString(R.string.upload_fail_line1, new Object[]{this.mTransInfo.mDeviceName}));
            this.mLine2View = (TextView) this.mView.findViewById(R.id.line2_view);
            this.mLine2View.setText(getString(R.string.upload_fail_line1_2, new Object[]{this.mTransInfo.mFileName}));
            this.mLine3View = (TextView) this.mView.findViewById(R.id.line3_view);
            this.mLine3View.setText(getString(R.string.download_fail_line3, new Object[]{BluetoothOppUtility.getStatusDescription(this, this.mTransInfo.mStatus, this.mTransInfo.mDeviceName)}));
            this.mLine5View = (TextView) this.mView.findViewById(R.id.line5_view);
            this.mLine5View.setVisibility(8);
        ...
        switch (i) {
            case -2:
                if (this.mWhichDialog != 0 && this.mWhichDialog != 3) {
                    ...
                    String string = "";
                    if (this.mWhichDialog == 0) {
                        string = getString(R.string.bt_toast_3, new Object[]{this.mTransInfo.mDeviceName});
                    } else if (this.mWhichDialog == 3) {
                        string = getString(R.string.bt_toast_6, new Object[]{this.mTransInfo.mDeviceName});
                    }
                ...
                if (this.mWhichDialog != 1) {
                    if (this.mWhichDialog != 5) {
                        ...
                        if (str != null) {
                            ...
                            Toast.makeText((Context) this, (CharSequence) getString(R.string.bt_toast_4, new Object[]{BluetoothOppManager.getInstance(this).getDeviceName(this.mAdapter.getRemoteDevice(this.mTransInfo.mDestAddr))}), 0).show();
                            break;
                        }
                    }
                } else {
