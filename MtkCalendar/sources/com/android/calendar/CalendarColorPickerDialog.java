...
public class CalendarColorPickerDialog extends ColorPickerDialog {
        ...
        protected void onQueryComplete(int i, Object obj, Cursor cursor) {
            ...
            if (i == 4) {
                if (cursor.moveToFirst()) {
                    ...
                    CalendarColorPickerDialog.this.mColors = new int[numArr.length];
    ...
    private class OnCalendarColorSelectedListener implements ColorPickerSwatch.OnColorSelectedListener {
        ...
        public void onColorSelected(int i) {
            if (i == CalendarColorPickerDialog.this.mSelectedColor || CalendarColorPickerDialog.this.mService == null) {
                return;
            }
