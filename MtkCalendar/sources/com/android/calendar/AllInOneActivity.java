    ...
    public void onSaveInstanceState(Bundle bundle) {
        if (this.mOnCreateRequestPermissionFlag == 1 && checkPermissions(1) == null) {
            ...
            if (this.mCurrentView == 5) {
                ...
                Fragment fragmentFindFragmentById = getFragmentManager().findFragmentById(R.id.main_pane);
                if (fragmentFindFragmentById instanceof AgendaFragment) {
                    bundle.putLong("key_event_id", ((AgendaFragment) fragmentFindFragmentById).getLastShowEventId());
                }
            }
