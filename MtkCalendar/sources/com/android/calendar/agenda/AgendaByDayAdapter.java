...
public class AgendaByDayAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (this.mRowInfo == null || i > this.mRowInfo.size()) {
            return this.mAgendaAdapter.getView(i, viewInflate, viewGroup);
        }
        RowInfo rowInfo = this.mRowInfo.get(i);
        if (rowInfo.mType == 0) {
            if (viewInflate != null && view.getTag() != null) {
            ...
            if (viewHolder == null) {
                ...
                viewInflate = this.mInflater.inflate(R.layout.agenda_day, viewGroup, false);
                viewHolder.dayView = (TextView) viewInflate.findViewById(R.id.day);
                viewHolder.dateView = (TextView) viewInflate.findViewById(R.id.date);
                viewHolder.julianDay = rowInfo.mDay;
            ...
            if (rowInfo.mDay > this.mTodayJulianDay) {
                viewInflate.setBackgroundResource(R.drawable.agenda_item_bg_primary);
                viewHolder.grayed = false;
            } else {
                viewInflate.setBackgroundResource(R.drawable.agenda_item_bg_secondary);
                viewHolder.grayed = true;
            }
            return viewInflate;
        }
        if (rowInfo.mType == 1) {
            View view2 = this.mAgendaAdapter.getView(rowInfo.mPosition, viewInflate, viewGroup);
            AgendaAdapter.ViewHolder viewHolder2 = (AgendaAdapter.ViewHolder) view2.getTag();
