...
public class Utils {
    ...
    public static void setTodayIcon(LayerDrawable layerDrawable, Context context, String str) {
        ...
        if (drawableFindDrawableByLayerId != null && (drawableFindDrawableByLayerId instanceof DayOfMonthDrawable)) {
            dayOfMonthDrawable = (DayOfMonthDrawable) drawableFindDrawableByLayerId;
        } else {
