...
public class PageDialogsHandler {
    ...
    private AlertDialog.Builder createSslCertificateDialog(SslCertificate sslCertificate, SslError sslError) {
        ...
        if (sslError == null) {
            ...
            ((TextView) ((LinearLayout) layoutInflaterFrom.inflate(R.layout.ssl_success, linearLayout)).findViewById(R.id.success)).setText(android.R.string.mediasize_iso_b2);
        } else {
