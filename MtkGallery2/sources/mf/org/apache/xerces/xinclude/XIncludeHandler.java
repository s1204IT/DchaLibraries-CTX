...
public class XIncludeHandler implements XMLComponent, XMLDTDFilter, XMLDocumentFilter {
    ...
    protected boolean handleIncludeElement(XMLAttributes attributes) throws IOException, XNIException {
        String accept;
        ...
        String accept2 = attributes.getValue(XINCLUDE_ATTR_ACCEPT);
        String acceptLanguage2 = attributes.getValue(XINCLUDE_ATTR_ACCEPT_LANGUAGE);
        if (parse == null) {
        ...
        String href2 = href;
        if (href2.length() == 0 && XINCLUDE_PARSE_XML.equals(parse2)) {
            if (xpointer != null) {
                Locale locale = this.fErrorReporter != null ? this.fErrorReporter.getLocale() : null;
                Object reason = this.fXIncludeMessageFormatter.formatMessage(locale, "XPointerStreamability", null);
                reportResourceError("XMLResourceError", new Object[]{href2, reason});
                return false;
            }
        ...
        URI hrefURI = null;
        try {
            hrefURI = new URI(href2, true);
            if (hrefURI.getFragment() != null) {
                reportFatalError("HrefFragmentIdentifierIllegal", new Object[]{href2});
            }
        } catch (URI.MalformedURIException e) {
            String newHref = escapeHref(href2);
            if (href2 != newHref) {
                href2 = newHref;
                try {
                    hrefURI = new URI(href2, true);
                    ...
                    reportFatalError("HrefSyntacticallyInvalid", new Object[]{href2});
                }
            } else {
                reportFatalError("HrefSyntacticallyInvalid", new Object[]{href2});
            }
        ...
        String href3 = href2;
        if (accept2 == null || isValidInHTTPHeader(accept2)) {
            accept = accept2;
        } else {
            reportFatalError("AcceptMalformed", null);
            accept = null;
        }
        if (acceptLanguage2 == null || isValidInHTTPHeader(acceptLanguage2)) {
            acceptLanguage = acceptLanguage2;
        } else {
            reportFatalError("AcceptLanguageMalformed", null);
            acceptLanguage = null;
        }
        XMLInputSource includedSource2 = null;
        if (this.fEntityResolver != null) {
            try {
                XMLResourceIdentifier resourceIdentifier = new XMLResourceIdentifierImpl(null, href3, this.fCurrentBaseURI.getExpandedSystemId(), XMLEntityManager.expandSystemId(href3, this.fCurrentBaseURI.getExpandedSystemId(), false));
                XMLInputSource includedSource3 = this.fEntityResolver.resolveEntity(resourceIdentifier);
                if (includedSource3 != null) {
                    try {
                        if ((includedSource3 instanceof HTTPInputSource) || (accept == null && acceptLanguage == null)) {
                            includedSource = includedSource3;
                        }
                        if (includedSource3.getCharacterStream() == null && includedSource3.getByteStream() == null) {
                            try {
                                includedSource2 = createInputSource(includedSource3.getPublicId(), includedSource3.getSystemId(), includedSource3.getBaseSystemId(), accept, acceptLanguage);
                                includedSource = includedSource2;
                            } catch (IOException e3) {
                                e = e3;
                                reportResourceError("XMLResourceError", new Object[]{href3, e.getMessage()}, e);
                                return false;
                            }
                        }
                        includedSource = includedSource3;
        ...
        if (includedSource == null) {
            includedSource = (accept == null && acceptLanguage == null) ? new XMLInputSource(null, href3, this.fCurrentBaseURI.getExpandedSystemId()) : createInputSource(null, href3, this.fCurrentBaseURI.getExpandedSystemId(), accept, acceptLanguage);
        }
        XMLInputSource includedSource4 = includedSource;
        if (parse2.equals(XINCLUDE_PARSE_XML)) {
            ...
            if (xpointer != null) {
                ...
                try {
                    ...
                    reportResourceError("XMLResourceError", new Object[]{href3, ex.getMessage()});
                    return false;
                }
            } else {
            ...
            try {
                ...
                this.fChildConfig.parse(includedSource4);
                this.fXIncludeLocator.setLocator(this.fDocLocation);
                if (this.fErrorReporter != null) {
                    this.fErrorReporter.setDocumentLocator(this.fDocLocation);
                }
                if (xpointer != null && !this.fXPtrProcessor.isXPointerResolved()) {
                    ...
                    Object reason2 = this.fXIncludeMessageFormatter.formatMessage(locale2, "XPointerResolutionUnsuccessful", null);
                    reportResourceError("XMLResourceError", new Object[]{href3, reason2});
                    return false;
                }
                ...
                reportResourceError("XMLResourceError", new Object[]{href3, e6.getMessage()}, e6);
                return false;
                ...
                reportFatalError("XMLParseError", new Object[]{href3});
            } finally {
                this.fNamespaceContext.popScope();
            }
        } else if (parse2.equals(XINCLUDE_PARSE_TEXT)) {
            String encoding = attributes.getValue(XINCLUDE_ATTR_ENCODING);
            includedSource4.setEncoding(encoding);
            XIncludeTextReader textReader2 = null;
            try {
                try {
                    this.fHasIncludeReportedContent = false;
                    if (this.fIsXML11) {
                        if (this.fXInclude11TextReader == null) {
                            this.fXInclude11TextReader = new XInclude11TextReader(includedSource4, this, this.fBufferSize);
                        } else {
                            this.fXInclude11TextReader.setInputSource(includedSource4);
                        }
                        textReader = this.fXInclude11TextReader;
                    } else {
                        if (this.fXInclude10TextReader == null) {
                            this.fXInclude10TextReader = new XIncludeTextReader(includedSource4, this, this.fBufferSize);
                        } else {
                            this.fXInclude10TextReader.setInputSource(includedSource4);
                        }
                        textReader = this.fXInclude10TextReader;
                    }
                    textReader2 = textReader;
                    textReader2.setErrorReporter(this.fErrorReporter);
                    textReader2.parse();
                    if (textReader2 != null) {
                        try {
                            textReader2.close();
                            ...
                            e = e8;
                            str = "TextResourceError";
                            objArr = new Object[]{href3, e.getMessage()};
                            reportResourceError(str, objArr, e);
                            return false;
                        }
                    }
                } catch (Throwable e9) {
            ...
            } catch (MalformedByteSequenceException ex2) {
                this.fErrorReporter.reportError(ex2.getDomain(), ex2.getKey(), ex2.getArguments(), (short) 2, (Exception) ex2);
                if (textReader2 != null) {
                    try {
                        textReader2.close();
                ...
                this.fErrorReporter.reportError("http://www.w3.org/TR/1998/REC-xml-19980210", "CharConversionFailure", (Object[]) null, (short) 2, (Exception) e12);
                if (textReader2 != null) {
                    try {
                        textReader2.close();
                ...
                reportResourceError("TextResourceError", new Object[]{href3, e14.getMessage()}, e14);
                if (textReader2 != null) {
                    try {
                        textReader2.close();
                    } catch (IOException e15) {
                        reportResourceError("TextResourceError", new Object[]{href3, e15.getMessage()}, e15);
                        return false;
                    }
                }
                return false;
            ...
            reportFatalError("InvalidParseValue", new Object[]{parse2});
        }
        return true;
    }
    ...
    protected XMLAttributes processAttributes(XMLAttributes attributes) throws URI.MalformedURIException {
        String str;
        String strIntern;
        String str2;
        String uri;
                ...
                if (parentURI != uri2 && attributes != null) {
                    if (prefix == XMLSymbols.EMPTY_STRING) {
                        if (attributes.getValue(NamespaceContext.XMLNS_URI, XMLSymbols.PREFIX_XMLNS) == null) {
                            ...
                            int index3 = attributes.addAttribute(ns, str3, str);
                        ...
                        ns2.rawname = String.valueOf(ns2.rawname) + prefix;
                        if (this.fSymbolTable != null) {
                        ...
                        int index4 = attributes.addAttribute(ns2, str4, str2);
    ...
    protected void copyFeatures(XMLComponentManager from, ParserConfigurationSettings to) {
        ...
        Enumeration features2 = Constants.getSAXFeatures();
        copyFeatures1(features2, Constants.SAX_FEATURE_PREFIX, from, to);
    }
    ...
    private String escapeHref(String href) {
        ...
        int i = 0;
        while (i < len && (ch = href.charAt(i)) <= 126) {
            if (ch < 32) {
                return href;
            }
            if (gNeedEscaping[ch]) {
        ...
        if (i < len) {
            int j = i;
            while (j < len) {
                int ch3 = href.charAt(j);
                if ((ch3 < 32 || ch3 > 126) && ((ch3 < 160 || ch3 > 55295) && ((ch3 < 63744 || ch3 > 64975) && (ch3 < 65008 || ch3 > 65519)))) {
                    if (XMLChar.isHighSurrogate(ch3) && (j = j + 1) < len) {
                        int ch22 = href.charAt(j);
                        if (!XMLChar.isLowSurrogate(ch22) || (ch2 = XMLChar.supplemental((char) ch3, (char) ch22)) >= 983040 || (65535 & ch2) > 65533) {
                        }
                    }
                    return href;
                }
            ...
            try {
                byte[] bytes = href.substring(i).getBytes("UTF-8");
