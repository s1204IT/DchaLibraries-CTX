...
public class XMLEntityManager implements XMLComponent, XMLEntityResolver {
    ...
    public void addExternalEntity(String name, String publicId, String literalSystemId, String baseSystemId) throws IOException {
        ...
        if (!this.fEntities.containsKey(name)) {
                ...
                while (true) {
                    if (i >= 0) {
                        ...
                        if (externalEntity.entityLocation == null || externalEntity.entityLocation.getExpandedSystemId() == null) {
                            ...
                            baseSystemId2 = externalEntity.entityLocation.getExpandedSystemId();
                            break;
                        }
                    } else {
                        break;
            ...
            this.fEntities.put(name, new ExternalEntity(name, new XMLEntityDescriptionImpl(name, publicId, literalSystemId, baseSystemId2, expandSystemId(literalSystemId, baseSystemId2, false)), null, this.fInExternalSubset));
            return;
        }
    ...
    public XMLInputSource resolveEntity(XMLResourceIdentifier resourceIdentifier) throws IOException, XNIException {
        ...
        if (xmlInputSource == null) {
            XMLInputSource xmlInputSource2 = new XMLInputSource(publicId, literalSystemId, baseSystemId);
        ...
        for (int i = size; i >= 0; i--) {
            ...
            if (activeEntity.name == entityName) {
                ...
                for (int j = i + 1; j < size; j++) {
                    Entity activeEntity2 = (Entity) this.fEntityStack.elementAt(j);
                    path.append(" -> ");
                    path.append(activeEntity2.name);
                }
                path.append(" -> ");
                ...
                if (this.fEntityHandler != null) {
                    ...
                    if (external) {
                        ...
                        String extLitSysId2 = externalEntity2.entityLocation != null ? externalEntity2.entityLocation.getLiteralSystemId() : null;
                        String extBaseSysId2 = externalEntity2.entityLocation != null ? externalEntity2.entityLocation.getBaseSystemId() : null;
                        String expandedSystemId2 = expandSystemId(extLitSysId2, extBaseSysId2, false);
    ...
    public String setupCurrentEntity(String name, XMLInputSource xmlInputSource, boolean literal, boolean isExternal) throws IOException, XNIException {
        ...
        Reader reader;
        String expandedSystemId2;
        Reader reader2;
        Boolean isBigEndian;
        int i;
        Boolean isBigEndian2;
        Boolean isBigEndian3;
        Reader reader3;
        String literalSystemId2;
        String publicId2 = xmlInputSource.getPublicId();
        String redirect = xmlInputSource.getSystemId();
        String baseSystemId = xmlInputSource.getBaseSystemId();
        String encoding2 = xmlInputSource.getEncoding();
        boolean encodingExternallySpecified = encoding2 != null;
        Boolean isBigEndian4 = null;
        this.fTempByteBuffer = null;
        Reader reader4 = xmlInputSource.getCharacterStream();
        String expandedSystemId3 = expandSystemId(redirect, baseSystemId, this.fStrictURI);
        if (baseSystemId == null) {
            baseSystemId = expandedSystemId3;
        }
        String baseSystemId2 = baseSystemId;
        if (reader4 != null) {
            publicId = publicId2;
            encoding = encoding2;
            stream = null;
            expandedSystemId = expandedSystemId3;
            literalSystemId = redirect;
            reader = reader4;
        } else {
            InputStream stream2 = xmlInputSource.getByteStream();
            if (stream2 == null) {
                URL location = new URL(expandedSystemId3);
                ...
                if (!(connect instanceof HttpURLConnection)) {
                    ...
                    if (xmlInputSource instanceof HTTPInputSource) {
                        ...
                        literalSystemId2 = redirect;
                        Iterator propIter = httpInputSource.getHTTPRequestProperties();
                        while (propIter.hasNext()) {
                            Iterator propIter2 = propIter;
                    ...
                    if (followRedirects) {
                        ...
                        if (redirect.equals(expandedSystemId3)) {
                            redirect = literalSystemId2;
                        } else {
                            expandedSystemId3 = redirect;
                        }
                    }
                }
            }
            RewindableInputStream rewindableStream = new RewindableInputStream(stream2);
            int i2 = 4;
            if (encoding2 == null) {
                byte[] b4 = new byte[4];
                int count = 0;
                ...
                if (count != 4) {
                    expandedSystemId2 = expandedSystemId3;
                    reader3 = createReader(rewindableStream, encoding2, null);
                } else {
                    EncodingInfo info = getEncodingInfo(b4, count);
                    encoding2 = info.encoding;
                    isBigEndian4 = info.isBigEndian;
                    rewindableStream.reset();
                    if (!info.hasBOM) {
                        expandedSystemId2 = expandedSystemId3;
                    } else if (encoding2 == "UTF-8") {
                        expandedSystemId2 = expandedSystemId3;
                        rewindableStream.skip(3L);
                    } else {
                        expandedSystemId2 = expandedSystemId3;
                        if (encoding2 == "UTF-16") {
                            rewindableStream.skip(2L);
                        }
                    }
                    reader3 = createReader(rewindableStream, encoding2, isBigEndian4);
                }
            } else {
                expandedSystemId2 = expandedSystemId3;
                encoding2 = encoding2.toUpperCase(Locale.ENGLISH);
                int i3 = 2;
                if (encoding2.equals("UTF-8")) {
                    int[] b3 = new int[3];
                    int count2 = 0;
                    while (count2 < 3) {
                        b3[count2] = rewindableStream.readAndBuffer();
                        if (b3[count2] == -1) {
                            break;
                        }
                        count2++;
                    ...
                    reader3 = createReader(rewindableStream, "UTF-8", null);
                } else {
                    if (encoding2.equals("UTF-16")) {
                        int[] b42 = new int[4];
                        int count3 = 0;
                        while (count3 < i2) {
                            b42[count3] = rewindableStream.readAndBuffer();
                            if (b42[count3] == -1) {
                                break;
                            }
                            count3++;
                        ...
                        if (count3 >= i3) {
                            ...
                            int b1 = b42[1];
                            if (b0 == 254 && b1 == 255) {
                                Boolean isBigEndian5 = Boolean.TRUE;
                                rewindableStream.skip(2L);
                                publicId = publicId2;
                                isBigEndian4 = isBigEndian5;
                            } else {
                                if (b0 == 255 && b1 == 254) {
                                    isBigEndian3 = Boolean.FALSE;
                                    publicId = publicId2;
                                    rewindableStream.skip(2L);
                                } else {
                                    publicId = publicId2;
                                ...
                                isBigEndian4 = isBigEndian3;
                            }
                        } else {
                            publicId = publicId2;
                        }
                        reader2 = createReader(rewindableStream, "UTF-16", isBigEndian4);
                    } else {
                        publicId = publicId2;
                        if (encoding2.equals("ISO-10646-UCS-4")) {
                            int[] b43 = new int[4];
                            int count4 = 0;
                            for (int i4 = 4; count4 < i4; i4 = 4) {
                                b43[count4] = rewindableStream.readAndBuffer();
                                if (b43[count4] == -1) {
                                    break;
                                }
                                count4++;
                            ...
                            rewindableStream.reset();
                            if (count4 == 4) {
                                if (b43[0] != 0 || b43[1] != 0 || b43[2] != 0) {
                                    i = 60;
                                } else {
                                    i = 60;
                                    if (b43[3] == 60) {
                                        isBigEndian2 = Boolean.TRUE;
                                    }
                                    isBigEndian4 = isBigEndian2;
                                }
                                if (b43[0] == i && b43[1] == 0 && b43[2] == 0 && b43[3] == 0) {
                                    isBigEndian2 = Boolean.FALSE;
                                    isBigEndian4 = isBigEndian2;
                                }
                            }
                            reader2 = createReader(rewindableStream, encoding2, isBigEndian4);
                        } else if (encoding2.equals("ISO-10646-UCS-2")) {
                            int i5 = 4;
                            int[] b44 = new int[4];
                            int count5 = 0;
                            while (count5 < i5) {
                                b44[count5] = rewindableStream.readAndBuffer();
                                if (b44[count5] == -1) {
                                    break;
                                }
                                i5 = 4;
                            ...
                            encoding = encoding2;
                            reader = createReader(rewindableStream, encoding2, null);
                            expandedSystemId = expandedSystemId2;
                        }
                    }
                    literalSystemId = redirect;
                    stream = rewindableStream;
        ...
        String publicId3 = publicId;
        String literalSystemId3 = literalSystemId;
        String literalSystemId4 = expandedSystemId;
        this.fCurrentEntity = new ScannedEntity(name, new XMLResourceIdentifierImpl(publicId3, literalSystemId, baseSystemId2, expandedSystemId), stream, reader, this.fTempByteBuffer, encoding, literal, false, isExternal);
        ...
        this.fResourceIdentifier.setValues(publicId3, literalSystemId3, baseSystemId2, literalSystemId4);
        return encoding;
    }
    ...
    private static synchronized URI getUserDir() throws URI.MalformedURIException {
        ...
        if (len >= 2 && userDir2.charAt(1) == ':' && (ch = Character.toUpperCase(userDir2.charAt(0))) >= 65 && ch <= 90) {
            buffer.append('/');
        }
        int i = 0;
        while (i < len) {
            int ch2 = userDir2.charAt(i);
            if (ch2 >= 128) {
                break;
            }
        ...
        if (i < len) {
            try {
                byte[] bytes = userDir2.substring(i).getBytes("UTF-8");
                for (byte b : bytes) {
                    if (b < 0) {
                        int ch3 = b + 256;
                        buffer.append('%');
                ...
                return new URI("file", "", userDir2, null, null);
            }
        }
    ...
    public static OutputStream createOutputStream(String uri) throws IOException {
        ...
        OutputStream out2 = urlCon.getOutputStream();
        return out2;
    }
    ...
    protected static String fixURI(String str) {
        ...
        if (str2.length() >= 2) {
            ...
            if (ch1 == ':') {
                ...
                if (ch0 >= 'A' && ch0 <= 'Z') {
                    sb = new StringBuffer(str2.length() + 8);
                    sb.append("file:///");
                }
            } else if (ch1 == '/' && str2.charAt(0) == '/') {
                sb = new StringBuffer(str2.length() + 5);
                sb.append("file:");
            }
        }
        ...
        if (sb == null) {
            sb = new StringBuffer(str2.length());
        }
        for (int i = 0; i < pos; i++) {
            sb.append(str2.charAt(i));
        }
        sb.append("%20");
        for (int i2 = pos + 1; i2 < str2.length(); i2++) {
            if (str2.charAt(i2) == ' ') {
                sb.append("%20");
            } else {
    ...
    public class ScannedEntity extends Entity {
        ...
        public String toString() {
            ...
            str.append(",baseCharOffset=");
            str.append(this.baseCharOffset);
            str.append(",startPosition=");
            str.append(this.startPosition);
            return str.toString();
        }
    }
