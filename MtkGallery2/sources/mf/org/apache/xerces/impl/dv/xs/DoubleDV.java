...
public class DoubleDV extends TypeValidator {
    ...
    private static final class XDouble implements XSDouble {
        ...
        public boolean isIdentical(XDouble val) {
            ...
            return this.value == val.value ? this.value != 0.0d || Double.doubleToLongBits(this.value) == Double.doubleToLongBits(val.value) : (this.value == this.value || val.value == val.value) ? false : true;
        }
