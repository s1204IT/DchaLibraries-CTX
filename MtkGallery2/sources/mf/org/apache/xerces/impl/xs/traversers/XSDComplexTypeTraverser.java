...
class XSDComplexTypeTraverser extends XSDAbstractParticleTraverser {
    ...
    private void traverseComplexContent(Element complexContentElement, boolean mixedOnType, XSDocumentInfo schemaDoc, SchemaGrammar grammar) throws ComplexTypeRecoverableError {
        ...
        XSComplexTypeDecl baseType2 = (XSComplexTypeDecl) type;
        this.fBaseType = baseType2;
        if ((baseType2.getFinal() & this.fDerivedBy) != 0) {
            this.fAttrChecker.returnAttrArray(complexContentAttrValues, schemaDoc);
            this.fAttrChecker.returnAttrArray(derivationTypeAttrValues3, schemaDoc);
            String errorKey = this.fDerivedBy == 1 ? "cos-ct-extends.1.1" : "derivation-ok-restriction.1";
        ...
        try {
            ...
            XSComplexTypeDecl baseType3 = baseType;
            XSParticleDecl baseContent = (XSParticleDecl) baseType3.getParticle();
            if (this.fDerivedBy != 2) {
                if (this.fParticle == null) {
                    this.fContentType = baseType3.getContentType();
                    this.fXSSimpleType = (XSSimpleType) baseType3.getSimpleType();
                    this.fParticle = baseContent;
                } else if (baseType3.getContentType() != 0) {
                    if (this.fContentType == 2 && baseType3.getContentType() != 2) {
                        this.fAttrChecker.returnAttrArray(complexContentAttrValues, schemaDoc);
                        this.fAttrChecker.returnAttrArray(derivationTypeAttrValues, schemaDoc);
                        throw new ComplexTypeRecoverableError("cos-ct-extends.1.4.3.2.2.1.a", new Object[]{this.fName}, complexContent3);
                    }
                    if (this.fContentType == 3 && baseType3.getContentType() != 3) {
                        this.fAttrChecker.returnAttrArray(complexContentAttrValues, schemaDoc);
                        this.fAttrChecker.returnAttrArray(derivationTypeAttrValues, schemaDoc);
                        throw new ComplexTypeRecoverableError("cos-ct-extends.1.4.3.2.2.1.b", new Object[]{this.fName}, complexContent3);
                    }
                    if ((this.fParticle.fType == 3 && ((XSModelGroupImpl) this.fParticle.fValue).fCompositor == 103) || (((XSParticleDecl) baseType3.getParticle()).fType == 3 && ((XSModelGroupImpl) ((XSParticleDecl) baseType3.getParticle()).fValue).fCompositor == 103)) {
                        this.fAttrChecker.returnAttrArray(complexContentAttrValues, schemaDoc);
                        this.fAttrChecker.returnAttrArray(derivationTypeAttrValues, schemaDoc);
                    ...
                    group.fParticles[0] = (XSParticleDecl) baseType3.getParticle();
                ...
                try {
                    mergeAttributes(baseType3.getAttrGrp(), this.fAttrGrp, this.fName, true, complexContent3);
                } catch (ComplexTypeRecoverableError e2) {
                    e = e2;
                    this.fAttrChecker.returnAttrArray(complexContentAttrValues, schemaDoc);
                    this.fAttrChecker.returnAttrArray(derivationTypeAttrValues, schemaDoc);
                ...
                if (this.fContentType == 3 && baseType3.getContentType() != 3) {
                    this.fAttrChecker.returnAttrArray(complexContentAttrValues, schemaDoc);
                    this.fAttrChecker.returnAttrArray(derivationTypeAttrValues, schemaDoc);
                    throw new ComplexTypeRecoverableError("derivation-ok-restriction.5.4.1.2", new Object[]{this.fName, baseType3.getName()}, complexContent3);
                }
                ...
                try {
                    mergeAttributes(baseType3.getAttrGrp(), this.fAttrGrp, this.fName, false, complexContent4);
                    this.fAttrGrp.removeProhibitedAttrs();
                    if (baseType3 != SchemaGrammar.fAnyType && (errArgs = this.fAttrGrp.validRestrictionOf(this.fName, baseType3.getAttrGrp())) != null) {
                        this.fAttrChecker.returnAttrArray(complexContentAttrValues, schemaDoc);
                        this.fAttrChecker.returnAttrArray(derivationTypeAttrValues, schemaDoc);
