        ...
        switch (dvIndex) {
            case DT_POSINT:
                try {
                    ...
                    Object retValue = fXIntPool.getXInt(Integer.parseInt(value));
            ...
            case DT_NONNEGINT:
                try {
                    ...
                    Object retValue2 = fXIntPool.getXInt(Integer.parseInt(value));
                    if (((XInt) retValue2).intValue() >= 0) {
                        return retValue2;
                    }
            ...
            case DT_FINAL1:
                ...
                return fXIntPool.getXInt(choice2);
            case -3:
            case -2:
                int choice3 = 0;
                if (value.equals(SchemaSymbols.ATTVAL_POUNDALL)) {
                ...
                return fXIntPool.getXInt(choice3);
            case -1:
                int choice4 = 0;
                if (value.equals(SchemaSymbols.ATTVAL_POUNDALL)) {
                    choice4 = 31;
                ...
                return fXIntPool.getXInt(choice4);
            default:
                return null;
        }
    }
