...
class XSDWildcardTraverser extends XSDAbstractTraverser {
    ...
    XSWildcardDecl traverseWildcardDecl(Element elmNode, Object[] attrValues, XSDocumentInfo schemaDoc, SchemaGrammar grammar) {
        ...
        XSAnnotationImpl annotation2 = null;
        if (child != null) {
            ...
            if (text2 != null) {
                annotation2 = traverseSyntheticAnnotation(elmNode, text2, attrValues, false, schemaDoc);
            }
        }
        if (annotation2 != null) {
            annotations = new XSObjectListImpl();
            ((XSObjectListImpl) annotations).addXSObject(annotation2);
        } else {
