...
class XSDAttributeTraverser extends XSDAbstractTraverser {
        ...
        if (attribute2 != null) {
            ...
            if (attrDecl.getAttributeNode(SchemaSymbols.ATT_REF) == null) {
                ...
                if (annotation3 != null) {
                    ...
                    ((XSObjectListImpl) annotations).addXSObject(annotation3);
                } else {
    ...
    XSAttributeDecl traverseNamedAttr(Element attrDecl, Object[] attrValues, XSDocumentInfo schemaDoc, SchemaGrammar grammar, boolean isGlobal, XSComplexTypeDecl enclosingCT) {
        ...
        if (isGlobal) {
            ...
            if (child == null) {
                ...
                if (localName.equals(tnsAtt7)) {
                    ...
                    attribute3.setValues(nameAtt2, tnsAtt5, attrType3, constraintType2, scope, attDefault2, enclCT, annotations2);
                    if (nameAtt2 == null) {
                        if (isGlobal) {
                    ...
                    if (attDefault3 != null) {
                        ...
                        try {
                            ...
                            attDefault4 = null;
                            attribute3.setValues(nameAtt, tnsAtt5, attrType3, (short) 0, scope, null, enclCT, annotations2);
                        }
                    }
        ...
        annotations2 = annotations;
        attribute3.setValues(nameAtt2, tnsAtt5, attrType3, constraintType22, scope, attDefault2, enclCT, annotations2);
        if (nameAtt2 == null) {
        }
        if (child != null) {
        }
