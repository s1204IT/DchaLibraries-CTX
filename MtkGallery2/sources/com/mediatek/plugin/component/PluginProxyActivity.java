...
public class PluginProxyActivity extends Activity implements IProxy {
    ...
    private PluginBaseActivity launchTargetActivity(String str, ClassLoader classLoader) {
        Object objCreateInstance = ReflectUtils.createInstance(str, classLoader, new Object[0]);
        if (objCreateInstance != null && (objCreateInstance instanceof PluginBaseActivity)) {
            PluginBaseActivity pluginBaseActivity = (PluginBaseActivity) objCreateInstance;
            pluginBaseActivity.addProxyActivity(this);
            attach(pluginBaseActivity);
            return pluginBaseActivity;
        }
        return null;
    }
}
