...
public class IngestObjectInfo implements Comparable<IngestObjectInfo> {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.mCompressedSize == ingestObjectInfo.mCompressedSize && this.mDateCreated == ingestObjectInfo.mDateCreated && this.mFormat == ingestObjectInfo.mFormat && this.mHandle == ingestObjectInfo.mHandle) {
            return true;
        }
        return false;
    }
