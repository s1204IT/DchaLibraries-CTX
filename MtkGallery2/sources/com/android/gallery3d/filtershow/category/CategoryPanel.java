...
public class CategoryPanel extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        View viewFindViewById = linearLayout.findViewById(R.id.listItems);
        if (viewFindViewById instanceof CategoryTrack) {
            CategoryTrack categoryTrack = (CategoryTrack) viewFindViewById;
            if (this.mAdapter != null) {
