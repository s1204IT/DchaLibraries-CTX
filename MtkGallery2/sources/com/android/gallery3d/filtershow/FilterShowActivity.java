...
public class FilterShowActivity extends FragmentActivity implements DialogInterface.OnDismissListener, DialogInterface.OnShowListener, AdapterView.OnItemClickListener, PopupMenu.OnDismissListener, ShareActionProvider.OnShareTargetSelectedListener {
    ...
    public void loadEditorPanel(FilterRepresentation filterRepresentation, Editor editor) {
        ...
        if (z && fragmentFindFragmentByTag != null && (fragmentFindFragmentByTag instanceof MainPanel)) {
            MainPanel mainPanel = (MainPanel) fragmentFindFragmentByTag;
            ...
            ViewPropertyAnimator viewPropertyAnimatorAnimate = mainPanel.getView().animate();
    ...
    private void showSavingProgress(String str) {
        ...
        if (str == null) {
            ...
            string = getString(R.string.filtershow_saving_image, new Object[]{str});
        }
    ...
    public void onResume() {
        ...
        super.onResume();
        if (this.mIsNoneFilter && (fragmentFindFragmentByTag = getSupportFragmentManager().findFragmentByTag("MainPanel")) != null && (fragmentFindFragmentByTag instanceof MainPanel)) {
    ...
    private void fillLooks() {
        ...
        if (fragmentFindFragmentByTag != null && (fragmentFindFragmentByTag instanceof MainPanel)) {
            ((MainPanel) fragmentFindFragmentByTag).loadCategoryLookPanel(true);
        }
    }
    ...
    public void toggleImageStatePanel() {
        ...
        if (fragmentFindFragmentByTag != null) {
            if (fragmentFindFragmentByTag instanceof EditorPanel) {
                ((EditorPanel) fragmentFindFragmentByTag).showImageStatePanel(this.mShowingImageStatePanel);
            } else if (fragmentFindFragmentByTag instanceof MainPanel) {
                ((MainPanel) fragmentFindFragmentByTag).showImageStatePanel(this.mShowingImageStatePanel);
            }
        }
    }
    ...
    void resetHistory() {
        for (FilterRepresentation filterRepresentation : FiltersManager.getManager().getTools()) {
            if (filterRepresentation instanceof FilterRotateRepresentation) {
                ((FilterRotateRepresentation) filterRepresentation).setRotation(FilterRotateRepresentation.Rotation.ZERO);
            }
            if (filterRepresentation instanceof FilterMirrorRepresentation) {
                ((FilterMirrorRepresentation) filterRepresentation).setMirror(FilterMirrorRepresentation.Mirror.NONE);
            }
        }
