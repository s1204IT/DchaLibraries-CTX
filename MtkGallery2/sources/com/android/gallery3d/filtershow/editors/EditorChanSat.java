...
public class EditorChanSat extends ParametricEditor implements SeekBar.OnSeekBarChangeListener, FilterView {
    ...
    public String calculateUserMessage(Context context, String str, Object obj) {
        ...
        if (localRepresentation == null || !(localRepresentation instanceof FilterChanSatRepresentation)) {
            return "";
        }
        FilterChanSatRepresentation filterChanSatRepresentation = (FilterChanSatRepresentation) localRepresentation;
        String string = this.mContext.getString(this.mMenuStrings[filterChanSatRepresentation.getParameterMode()]);
    ...
    protected Parameter getParameterToEdit(FilterRepresentation filterRepresentation) {
        if (filterRepresentation instanceof FilterChanSatRepresentation) {
            ...
            Parameter filterParameter = filterChanSatRepresentation.getFilterParameter(filterChanSatRepresentation.getParameterMode());
    ...
    private FilterChanSatRepresentation getChanSatRep() {
        FilterRepresentation localRepresentation = getLocalRepresentation();
        if (localRepresentation != null && (localRepresentation instanceof FilterChanSatRepresentation)) {
            return (FilterChanSatRepresentation) localRepresentation;
        }
        return null;
    }
