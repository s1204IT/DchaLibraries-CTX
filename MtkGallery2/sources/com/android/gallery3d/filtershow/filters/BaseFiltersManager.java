    ...
    protected void init() {
        ...
        for (Class cls : vector) {
            try {
                ...
                if (objNewInstance instanceof ImageFilter) {
                    this.mFilters.put(cls, (ImageFilter) objNewInstance);
                    FilterRepresentation defaultRepresentation = ((ImageFilter) objNewInstance).getDefaultRepresentation();
