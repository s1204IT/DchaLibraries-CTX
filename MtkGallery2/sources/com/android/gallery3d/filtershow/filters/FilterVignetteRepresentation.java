...
public class FilterVignetteRepresentation extends FilterRepresentation implements Oval {
    ...
    public boolean equals(FilterRepresentation filterRepresentation) {
        if (super.equals(filterRepresentation) && (filterRepresentation instanceof FilterVignetteRepresentation)) {
            ...
            if (filterVignetteRepresentation.getCenterX() == getCenterX() && filterVignetteRepresentation.getCenterY() == getCenterY() && filterVignetteRepresentation.getRadiusX() == getRadiusX() && filterVignetteRepresentation.getRadiusY() == getRadiusY()) {
                return true;
            }
        }
        return false;
