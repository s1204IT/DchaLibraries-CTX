...
public class ImageSavingTask extends ProcessingTask {
    ...
    public void onUpdate(ProcessingTask.Update update) {
        if (update instanceof UpdatePreviewSaved) {
            UpdatePreviewSaved updatePreviewSaved = (UpdatePreviewSaved) update;
            this.mProcessingService.completePreviewSaveImage(updatePreviewSaved.uri, updatePreviewSaved.exit);
        }
