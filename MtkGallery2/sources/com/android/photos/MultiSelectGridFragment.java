    ...
    private void ensureGrid() {
        ...
        if (view instanceof GridView) {
            ...
            if (viewFindViewById != null && (viewFindViewById instanceof TextView)) {
                this.mEmptyView = (TextView) viewFindViewById;
            }
            this.mProgressContainer = view.findViewById(R.id.progressContainer);
            this.mGridContainer = view.findViewById(R.id.gridContainer);
            View viewFindViewById2 = view.findViewById(android.R.id.list);
            if (!(viewFindViewById2 instanceof GridView)) {
                throw new RuntimeException("Content has view with id attribute 'android.R.id.list' that is not a GridView class");
            }
            this.mGrid = (GridView) viewFindViewById2;
            if (this.mGrid == null) {
