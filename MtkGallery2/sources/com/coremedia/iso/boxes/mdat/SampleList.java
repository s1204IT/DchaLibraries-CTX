        ...
        for (Box box : this.isoFile.getBoxes()) {
            ...
            if ("mdat".equals(box.getType())) {
                if (box instanceof MediaDataBox) {
                    ...
                    long jLimit = ((long) mediaDataBox.getHeader().limit()) + j;
                    this.mdatStartCache.put(mediaDataBox, Long.valueOf(jLimit));
                    this.mdatEndCache.put(mediaDataBox, Long.valueOf(jLimit + size));
